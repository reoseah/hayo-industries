...
public class CompressorMenu extends ClassicMachineMenu {
    public CompressorMenu(int containerId, Inventory inventory) {
        super(Hayo.MenuTypes.COMPRESSOR, containerId, new SimpleContainer(ClassicMachineBlockEntity.SLOTS), new MachineContainerData.Clientside(), inventory);
    }

    public CompressorMenu(int containerId, CompressorBlockEntity entity, Inventory inventory) {
        super(Hayo.MenuTypes.COMPRESSOR, containerId, entity, new MachineContainerData.Serverside(entity), inventory);
    }
