...
public class MaceratorMenu extends ClassicMachineMenu {
    public MaceratorMenu(int containerId, Inventory inventory) {
        super(Hayo.MenuTypes.MACERATOR, containerId, new SimpleContainer(ClassicMachineBlockEntity.SLOTS), new MachineContainerData.Clientside(), inventory);
    }

    public MaceratorMenu(int containerId, MaceratorBlockEntity entity, Inventory inventory) {
        super(Hayo.MenuTypes.MACERATOR, containerId, entity, new MachineContainerData.Serverside(entity), inventory);
    }
