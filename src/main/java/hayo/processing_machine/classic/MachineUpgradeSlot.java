...
public class MachineUpgradeSlot extends Slot {
    ...
    protected final int lastUpgrade;

    public MachineUpgradeSlot(Container container, int slot, int x, int y, TagKey<Item> upgrades, int firstUpgrade, int lastUpgrade) {
    ...
    public boolean mayPlace(ItemStack stack) {
        ...
        if (stack.is(Hayo.ItemTags.NON_REPEATABLE_UPGRADES)) {
            for (int i = this.firstUpgrade; i < this.lastUpgrade; i++) {
