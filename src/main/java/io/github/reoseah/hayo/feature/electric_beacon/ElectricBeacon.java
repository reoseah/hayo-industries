...
public class ElectricBeacon {
    public static final ElectricBeaconOption NONE_1 = new ElectricBeaconOption(Hayo.modId("none_1"), Hayo.modId("electric_beacon_options/cross"), Component.translatable("hayo.electric_beacon.none"));
    public static final ElectricBeaconOption WIRELESS_CHARGE = new ElectricBeaconOption(Hayo.modId("wireless_charge"), Hayo.modId("electric_beacon_options/wireless_charge"), //
            Component.translatable("hayo.electric_beacon.wireless_charge"), //
            EnergyTexts.amountPerTick(32).withStyle(ChatFormatting.GRAY), //
            Component.translatable("hayo.horizontal_range.radius", 10).withStyle(ChatFormatting.GRAY), //
            Component.translatable("hayo.vertical_range.radius", 10).withStyle(ChatFormatting.GRAY));

    public static final ElectricBeaconOption NONE_2 = new ElectricBeaconOption(Hayo.modId("none_2"), Hayo.modId("electric_beacon_options/cross"), Component.translatable("hayo.electric_beacon.none"));
    public static final ElectricBeaconOption POWER_1 = new ElectricBeaconOption(Hayo.modId("power_1"), Hayo.modId("electric_beacon_options/power"), //
            Component.translatable("hayo.electric_beacon.power_1"), //
            Component.translatable("hayo.energy.amount_per_tick", "+32").withStyle(ChatFormatting.GRAY) //
    );
    public static final ElectricBeaconOption HORIZONTAL_RANGE_1 = new ElectricBeaconOption(Hayo.modId("horizontal_range_1"), Hayo.modId("electric_beacon_options/horizontal_range"), //
            Component.translatable("hayo.electric_beacon.horizontal_range_1"), //
            Component.translatable("hayo.horizontal_range.radius", "+10").withStyle(ChatFormatting.GRAY) //
    );
    public static final ElectricBeaconOption VERTICAL_RANGE_1 = new ElectricBeaconOption(Hayo.modId("vertical_range_1"), Hayo.modId("electric_beacon_options/vertical_range"), //
            Component.translatable("hayo.electric_beacon.vertical_range_1"), //
            Component.translatable("hayo.vertical_range.radius", "+10").withStyle(ChatFormatting.GRAY) //
    );

    public static final ElectricBeaconOption NONE_3 = new ElectricBeaconOption(Hayo.modId("none_3"), Hayo.modId("electric_beacon_options/cross"), Component.translatable("hayo.electric_beacon.none"));
    ...
    public static final ElectricBeaconOption NONE_4 = new ElectricBeaconOption(Hayo.modId("none_4"), Hayo.modId("electric_beacon_options/cross"), Component.translatable("hayo.electric_beacon.none"));
    ...
    public static final Map<Integer, List<ElectricBeaconOption>> OPTIONS_BY_TIER = Map.of(0, List.of(NONE_1, WIRELESS_CHARGE), 1, List.of(NONE_2, POWER_1, HORIZONTAL_RANGE_1, VERTICAL_RANGE_1), 2, List.of(NONE_3, POWER_2, HORIZONTAL_RANGE_2, VERTICAL_RANGE_2), 3, List.of(NONE_4, POWER_3, HORIZONTAL_RANGE_3, VERTICAL_RANGE_3));
