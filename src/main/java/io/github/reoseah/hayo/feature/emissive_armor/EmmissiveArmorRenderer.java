package io.github.reoseah.hayo.feature.emissive_armor;
...
public class EmmissiveArmorRenderer implements ArmorRenderer {
    ...
    public EmmissiveArmorRenderer(EntityRendererProvider.Context context, Identifier texture, Identifier overlayTexture) {
